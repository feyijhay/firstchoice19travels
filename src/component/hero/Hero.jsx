...
// import dubai from "../../asset/images/Dubai.jpg";
            ...
            >
                ...
                <div className="relative bg-black bg-opacity-50 p-6 rounded-lg max-w-3xl text-white z-20">
                    ...
                    <p className="mb-6 text-lg md:text-xl">
                        ...
                        itineraries,
                        expert advice, and stress-free planning.
                    </p>
                    <a
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col items-center text-center p-6 shadow-md rounded-lg bg-white">
                            ...
                            <p className="text-sm text-gray-700">
                                We design personalized itineraries based on your interests, budget,
                                and travel style. From flights and accommodations to activities and
                                tours, we take care of everything.
                            </p>
                        </div>

                        {/* Service 2 */}
                        <div className="flex flex-col items-center text-center p-6 shadow-md rounded-lg bg-white">
                            <FaPassport className="h-10 w-10 text-sky-500 mb-3"/> {/* Updated icon */}
                            ...
                            <p className="text-sm text-gray-700">
                                ...
                                Our team ensures accurate documentation and timely submission, saving you time and
                                hassle.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center text-center p-6 shadow-md rounded-lg bg-white">
                            ...
                            <p className="text-sm text-gray-700">
                                Get expert guidance on tourist and travel visa applications for various countries.
                                We handle documentation, appointments, and updates to simplify the entire process.
                            </p>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <div className="w-96 rounded-lg overflow-hidden shadow-md bg-white">
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        A dreamy escape with pristine beaches and luxury resorts.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-700 italic mb-4">
                                “Firstchoice19travels planned the perfect honeymoon for us! Everything was seamless,
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md">
                            <p className="text-gray-700 italic mb-4">
                                “I highly recommend Firstchoice19travels. Their expertise and attention to detail
                                made our family vacation unforgettable.”
                            </p>
            ...
            <section id="about" className="py-20 bg-sky-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
                        ...
                        {/* Right side: All about text together */}
                        <div className="space-y-6 text-left">
                            <p className="text-lg text-gray-700">
                                At Firstchoice19Travels, we believe travel is about creating meaningful memories and
                                fostering connections across cultures. With our years of industry experience, our expert
                                team ensures every journey is personalized and stress-free.
                            </p>

                            <p className="text-lg text-gray-700">
                                We are passionate about travel and dedicated to creating unique, personalized
                                experiences
                                for our clients. With years of experience exploring the globe, we offer expert advice
                                and
                                meticulous planning to ensure your trip is seamless and memorable.
                            </p>

                            <p className="text-lg text-gray-700">
                                Our mission is to transform your travel dreams into reality. Whether you're seeking a
                                relaxing beach getaway, an adventurous trek, or a cultural immersion, we're here to
                                handle
                                every detail.
                            </p>
